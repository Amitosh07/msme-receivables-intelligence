...
from backend.app.workers.handlers import (
    handle_parse_invoice,
    handle_parse_payment_proof,
    handle_predict_invoice,
)
...
TASK_HANDLERS: Dict[str, Callable[[Session, Task, Dict[str, Any]], None]] = {
    ...
    "parse_payment_proof": handle_parse_payment_proof,
